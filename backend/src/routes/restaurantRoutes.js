...
export const createRestaurantRouter = ({
  getAllRestaurantsFn = getAllRestaurants,
  createRestaurantFn = createRestaurant,
  updateRestaurantFn = updateRestaurant,
  deleteRestaurantFn = deleteRestaurant,
  dbClient = db,
  ...
  router.get("/", async (req, res) => {
    const restaurants = await getAllRestaurantsFn();
  ...
  router.post(
    ...
    async (req, res) => {
      ...
      const restaurant = await createRestaurantFn(
        name,
        description,
        image,
        cuisine,
  ...
  router.post("/:id/menu", uploadMiddleware.single("image"), processImageMiddleware, async (req, res) => {
    try {
      const restaurantId = req.params.id;
  ...
  router.delete("/:id", protectMiddleware, async (req, res) => {
    ...
    await deleteRestaurantFn(req.params.id);
